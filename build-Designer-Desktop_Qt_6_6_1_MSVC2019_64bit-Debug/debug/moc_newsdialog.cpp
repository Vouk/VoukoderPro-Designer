...
Q_CONSTINIT static const qt_meta_stringdata_CLASSNewsDialogENDCLASS_t qt_meta_stringdata_CLASSNewsDialogENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(11, 19),  // "unreadNewsAvailable"
        QT_MOC_LITERAL(31, 0),  // ""
        QT_MOC_LITERAL(32, 10),  // "unreadNews"
        QT_MOC_LITERAL(43, 7)   // "onCheck"
    },
    "NewsDialog",
    "unreadNewsAvailable",
    "",
...
void NewsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->unreadNewsAvailable((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        ...
        {
            using _t = void (NewsDialog::*)(bool );
            if (_t _q_method = &NewsDialog::unreadNewsAvailable; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void NewsDialog::unreadNewsAvailable(bool _t1)
{
