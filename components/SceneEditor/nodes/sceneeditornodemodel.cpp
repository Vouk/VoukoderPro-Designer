...
{
    QString labelText = QString::fromStdString(pluginInfo.name);
    if (pluginInfo.category.first != "ffmpeg")
        labelText = QString::fromStdString(pluginInfo.category.second) + " " + labelText;
